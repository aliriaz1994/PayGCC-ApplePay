...
use PL\Paygcc\Model\Benefitpay as BenefitpayModel;

abstract class Benefitpay extends Action
{
    /**
     * @var \PL\Paygcc\Model\Checkout\Benefitpay
     */
    protected $_benefitpayCheckout;
    ...
    protected $_configMethod = 'paygcc_benefitpay';

    protected $_checkoutType = \PL\Paygcc\Model\Checkout\Benefitpay::class;
    ...
    public function __construct(
        ...
        \PL\Paygcc\Model\Checkout\BenefitpayFactory $benefitpayFactory,
        \PL\Paygcc\Logger\Logger $plLogger,
        PaygccHelper $paygccHelper,
        BenefitpayModel $benefitpayModel,
    ...
    )
    {
        ...
        $this->_benefitpayFactory = $benefitpayFactory;
        $this->_plLogger = $plLogger;
        $this->_benefitpayModel = $benefitpayModel;
        ...
        $this->_benefitpayCheckout = $this->_benefitpayFactory->create(['params' => ['quote' => $this->_getQuote()]]);
    }
    ...
    protected function _initCheckout(CartInterface $quoteObject = null)
    {
        ...
        $this->_benefitpayCheckout = $this->_benefitpayFactory->create(['params' => ['quote' => $quote]]);
