...
abstract class Benefit extends Action
{
    /**
     * @var \PL\Paygcc\Model\Checkout\Benefit
     */
    protected $_benefitCheckout;
    ...
    protected $_configMethod = 'paygcc_benefit';

    protected $_checkoutType = \PL\Paygcc\Model\Checkout\Benefit::class;
    ...
    public function __construct(
        ...
        \PL\Paygcc\Model\Checkout\BenefitFactory $benefitFactory,
    ...
    )
    {
        ...
        $this->_benefitCheckout = $this->_benefitFactory->create(['params' => ['quote' => $this->_getQuote()]]);
    }
    ...
    protected function _initCheckout(CartInterface $quoteObject = null)
    {
        ...
        $this->_benefitCheckout = $this->_benefitFactory->create(['params' => ['quote' => $quote]]);
