...
class ApiCheckout
{
    protected $_methodType = 'paygcc_apicheckout';
    ...
    public function getPaymentRequest($cardValue = null)
    {
        ...
        $paymentUrl = $this->_apiCheckout->getPayGCCPaymentUrl($this->_quote,$cardValue);
        return $paymentUrl;
    }
